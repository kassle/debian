...
mmdebstrap \
    ...
    --include=whiptail,tzdata,nano,systemd-sysv,rsyslog,logrotate,acpi-support-base,sudo,tmux,ifupdown2,isc-dhcp-client,inetutils-ping,inetutils-traceroute,linux-image-amd64,grub-efi,systemd-timesyncd,dbus-user-session,openssh-server \
